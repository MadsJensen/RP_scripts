...
for subject in subjects:
    cls = np.load(source_folder + "graph_data/%s_cls_pow_sliding_bin.npy" %
                  subject).item()

    pln = np.load(source_folder + "graph_data/%s_pln_pow_sliding_bin.npy" %
                  subject).item()

    cls_tmp = []
    cls_tmp.append(cls["deg_alpha"])
    cls_tmp.append(cls["deg_beta"])
    cls_tmp.append(cls["deg_gamma_low"])
    cls_tmp.append(cls["deg_gamma_high"])

    pln_tmp = []
    pln_tmp.append(pln["deg_alpha"])
    pln_tmp.append(pln["deg_beta"])
